...
''' NOW NEED TO ADD WORDS FROM LIST INTO A CSV FILE'''
''' THEN NEED TO CACLCULATE THE POINTS FOR EACH WORD -  DO THAT BY CREATING A FUNCTION AND THEN DOING IT SIMULTANEOUSLY WITH ABOVE STEP!!'''

''' THEN CAN WORK ON SCRIPT'''
'''FOLLOWED BY THE GUI'''